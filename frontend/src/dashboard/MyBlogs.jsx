...
function MyBlogs() {
  ...
  const handleDelete = async (id) => {
    await axios
     .delete(`${import.meta.env.VITE_API_BASE_URL}/api/blogs/delete/${id}`, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  return (
    <div>
      <div className="container w-full flex justify-center my-10 px-2">
...
export default MyBlogs;//correct code
